  ...
  render() {
    return (
      ...
      >
        ...
        >
          <Text style={[style.title, fonts.style.bold]}>Envoyez du love !</Text>
          <Icon
            styleImage={{
              width: 100,
              height: 108
          ...
          <View>
            <Text style={style.text}>
              Offrez à vos amis{' '}
              <Text style={fonts.style.bold}>1 mois gratuit</Text>
            </Text>
          ...
          <Text style={[style.smallText]}>
            Et bénéficiez de{' '}
            <Text style={fonts.style.bold}>3 mois offerts !</Text>
          </Text>
          <Icon
            styleImage={{
              width: 60,
        ...
        <WarningPopup
          ...
          title={<Text>Oh vraiment ? :-(</Text>}
          message={
            <Text>
              Ne vous privez pas de faire plaisir et d’envoyer des bonnes
              nouvelles !
            </Text>
          }
          ignore={() => this.props.siginSuccess()}
