    ...
    return (
      ...
      > 
        <View style={styles.row}>
          ...
          />  
          <ChangePicture setPrictureSource={(pictureSource) => this.props.setPrictureSource(pictureSource)} />
        </View>
        <Text style={[
            fonts.style.t17,
            {fontWeight: '500',}
        ...
        <Text style={[fonts.style.normal,{color:colors.grayDate, marginBottom:20}]}>
          { user.city }
        </Text>
      </View> 
    );
